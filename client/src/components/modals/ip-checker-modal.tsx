...
`;
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-md fixed top-[210px] max-h-[calc(100vh-270px)] overflow-y-auto">
        <DialogHeader>
        ...
        <div className="py-2">
          <p className="text-sm text-gray-600 mb-4">
            Результаты проверки IP-адреса на спам и мошенничество. Отчёт формируется из запроса к нескольким антифрод-системам. Это позволяет предупредить блокировку по IP при работе с популярными онлайн-сервисами.
          </p>
